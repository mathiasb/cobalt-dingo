...
func Layout(title string, nav *UserNav) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if nav != nil {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, ">Production</option></select></form><a href=\"/fortnox/\" class=\"cd-nav-sub\" style=\"text-decoration:none;\">Fortnox</a> <span class=\"cd-nav-divider\">·</span> <span class=\"cd-nav-sub\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
